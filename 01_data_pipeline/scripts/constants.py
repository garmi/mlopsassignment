...
DB_PATH = "/workspace/Assignment/01_data_pipeline/scripts/"
...
DATA_DIRECTORY = "/workspace/Assignment/01_data_pipeline/scripts/data/"

# Path to the interaction mapping file
INTERACTION_MAPPING = "/workspace/Assignment/01_data_pipeline/scripts/interaction_mapping.csv"
